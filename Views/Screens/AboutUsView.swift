...
//                    .padding(.top, 16)
                ...
                // Our Promise
                SectionCard(icon: "heart.circle.fill", title: "Our Promise",
                ...
                // The Real Goal
                SectionCard(icon: "figure.walk.motion", title: "The Real Goal",
                ...
                // Focus on Yourself
                SectionCard(icon: "person.fill.checkmark", title: "Focus on Yourself",
                    ...
                    HStack(spacing: 12) {
                        ...
                        Text("Why We Built This")
                            ...
                            .foregroundColor(.text01)
                                            ...
                                            Text("We've been where you are — starting fresh, full of motivation, then struggling to keep it going. We built Habitto to make that journey feel lighter, kinder, and more sustainable:")
                            .font(.appBodyLarge)
                            .foregroundColor(.text05)
                            .fixedSize(horizontal: false, vertical: true)
