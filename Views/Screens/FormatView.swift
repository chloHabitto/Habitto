      ...
      VStack(spacing: 20) {
        ...
        VStack(alignment: .leading, spacing: 16) {
          ...
          VStack(alignment: .leading, spacing: 12) {
            HStack {
              Image(systemName: tempHeaderStyleSelection == "Tabs"
            ...
            HStack {
              Image(systemName: tempHeaderStyleSelection == "Today's Progress card"
                ? "checkmark.square.fill"
                : "square")
                .font(.system(size: 20))
                .foregroundColor(.primary)
        ...
        VStack(alignment: .leading, spacing: 16) {
          ...
          VStack(alignment: .leading, spacing: 12) {
            HStack {
              Image(systemName: tempHabitListStyleSelection == "List view"
                ? "checkmark.square.fill"
                : "square")
                .font(.system(size: 20))
                .foregroundColor(.primary)
            ...
            HStack {
              Image(systemName: tempHabitListStyleSelection == "Card View"
                ? "checkmark.square.fill"
                : "square")
                .font(.system(size: 20))
                .foregroundColor(.primary)
