...
struct CustomRatingView: View {
    ...
    var body: some View {
                                ...
                                TextEditor(text: $comment)
                                    ...
                                    .overlay(
                                        RoundedRectangle(cornerRadius: 8)
                                            .stroke(comment.count > maxCommentLength ? Color.red : Color.outline3, lineWidth: 1)
                                    )
                                    .cornerRadius(8)
                                    .frame(minHeight: 100)
        ...
        .alert("Open App Store", isPresented: $showingAppStore) {
            ...
            Text("We'll open the App Store where you can submit your review with your rating and comments.")
        }
    }
    ...
    private func storeRatingLocally() {
        ...
        print("⭐ CustomRatingView: Stored rating: \(selectedRating), comment: \(comment.isEmpty ? "none" : "\(comment.count) chars")")
    }
