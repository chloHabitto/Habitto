...
// MARK: - Migration Developer Settings View
        ...
        NavigationView {
            List {
                ...
                Section("Migration Status") {
                    HStack {
                        Image(systemName: telemetryManager.isMigrationEnabled ? "checkmark.circle.fill" : "xmark.circle.fill")
                ...
                Section("Remote Configuration") {
                    HStack {
                        Image(systemName: telemetryManager.remoteConfigLoaded ? "checkmark.circle.fill" : "exclamationmark.triangle.fill")
                ...
                Section("Telemetry Data") {
                    HStack {
                        ...
                        Text(String(format: "%.1f%%", telemetryManager.developerSettings.failureRate * 100))
                            .foregroundColor(telemetryManager.developerSettings.failureRate > 0.15 ? .red : .green)
                    }
                ...
                Section("Testing") {
                    ...
                    Button("Test Migration Failure") {
                        Task {
                            await telemetryManager.recordEvent(.migrationEndFailure, duration: 2.5, errorCode: "test_error", datasetSize: 100, success: false)
                        }
                    }
                    .foregroundColor(.red)
                    ...
                    Button("Test Kill Switch Trigger") {
                        Task {
                            await telemetryManager.recordEvent(.killSwitchTriggered, errorCode: "manual_test", success: false)
                        }
                    }
