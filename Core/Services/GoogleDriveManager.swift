...
final class GoogleDriveManager: ObservableObject {
  ...
  func uploadToGoogleDrive(_: Data, filename: String) async throws -> GoogleDriveUploadResult {
...
enum GoogleDriveError: LocalizedError {
  ...
  var errorDescription: String? {
    ...
    case .notImplemented:
      "Google Drive integration is not yet implemented"
    case .uploadFailed:
