...
enum CloudStorageError: LocalizedError {
  ...
  var errorDescription: String? {
    ...
    case .iCloudNotEnabled:
      "iCloud Drive is not enabled. Please enable it in Settings."
    case .fileNotFound:
      "Backup file not found in iCloud Drive"
    case .downloadTimeout:
      "Timeout while downloading file from iCloud"
    case .syncFailed:
      "Failed to sync file with iCloud Drive"
    }
  }
}

// MARK: - StorageStrategy
