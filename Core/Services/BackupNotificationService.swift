...
// MARK: - BackupNotificationService
...
enum NotificationType {
  ...
  var color: Color {
    switch self {
    case .success: .green500
    case .error: .red500
    case .warning: .yellow500
    case .info: .navy200
    }
  }
  ...
  var body: some View {
    if notificationService.showingNotification {
      ...
      .animation(
        ...
        value: notificationService.showingNotification)
    }
  }
}

// MARK: - BackupNotificationModifier
