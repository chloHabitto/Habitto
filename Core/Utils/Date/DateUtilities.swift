...
class DateUtilities {
  ...
  func isToday(_ date: Date) -> Bool {
    isSameDay(date, as: now)
  }

  /// Check if a date is yesterday
  func isYesterday(_ date: Date) -> Bool {
    isSameDay(date, as: addDays(-1, to: now))
  }
  ...
  func dayOfYear(for date: Date) -> Int {
    calendar.component(.dayOfYear, from: date)
  }
...
extension Date {
  ...
  @MainActor
  var startOfDay: Date {
    DateUtilities.shared.startOfDay(for: self)
  }

  /// Get end of day
  @MainActor
  var endOfDay: Date {
    DateUtilities.shared.endOfDay(for: self)
  }

  /// Get start of week
  @MainActor
  var startOfWeek: Date {
    DateUtilities.shared.startOfWeek(for: self)
  }

  /// Get end of week
  @MainActor
  var endOfWeek: Date {
    DateUtilities.shared.endOfWeek(for: self)
  }

  /// Get start of month
  @MainActor
  var startOfMonth: Date {
    DateUtilities.shared.startOfMonth(for: self)
  }

  /// Get end of month
  @MainActor
  var endOfMonth: Date {
    DateUtilities.shared.endOfMonth(for: self)
  }

  /// Check if date is today
  @MainActor
  var isToday: Bool {
    DateUtilities.shared.isToday(self)
  }

  /// Check if date is yesterday
  @MainActor
  var isYesterday: Bool {
    DateUtilities.shared.isYesterday(self)
  }

  /// Check if date is tomorrow
  @MainActor
  var isTomorrow: Bool {
    DateUtilities.shared.isTomorrow(self)
  }

  /// Check if date is in the past
  @MainActor
  var isPast: Bool {
    DateUtilities.shared.isPast(self)
  }

  /// Check if date is in the future
  @MainActor
  var isFuture: Bool {
    DateUtilities.shared.isFuture(self)
  }

  /// Get display string
  @MainActor
  var displayString: String {
    DateUtilities.shared.displayString(for: self)
  }

  /// Get short display string
  @MainActor
  var shortDisplayString: String {
    DateUtilities.shared.shortDisplayString(for: self)
  }

  /// Get time string
  @MainActor
  var timeString: String {
    DateUtilities.shared.timeString(for: self)
  }

  /// Get relative string
  @MainActor
  var relativeString: String {
    DateUtilities.shared.relativeString(for: self)
  }

  /// Get short relative string
  @MainActor
  var shortRelativeString: String {
    DateUtilities.shared.shortRelativeString(for: self)
  }
}
