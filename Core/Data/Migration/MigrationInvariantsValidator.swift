...
// MARK: - MigrationInvariantsValidator

// Comprehensive validation system for migration data integrity

enum MigrationInvariantsValidator {
  // MARK: Internal
  ...
  static func validateInvariants(
    ...
    previousVersion: String? = nil) async -> ValidationResult
  {
    let startTime = Date()
  ...
  private static func validateInvariant(
    _ type: InvariantType,
    context: ValidationContext) async
    -> (
      ...
      warnings: [ValidationResult.InvariantWarning])
  {
    ...
    case .primaryKeyUniqueness:
      validatePrimaryKeyUniqueness(context)
    case .referentialIntegrity:
      validateReferentialIntegrity(context)
    case .dataTypeValidity:
      validateDataTypeValidity(context)
    case .enumValueValidity:
      validateEnumValueValidity(context)
    case .dateBoundsValidity:
      validateDateBoundsValidity(context)
    case .counterMonotonicity:
      validateCounterMonotonicity(context)
    case .stringLengthBounds:
      validateStringLengthBounds(context)
    case .requiredFieldPresence:
      validateRequiredFieldPresence(context)
    case .relationshipConsistency:
      validateRelationshipConsistency(context)
    case .businessRuleCompliance:
      validateBusinessRuleCompliance(context)
    }
  }

  // MARK: - Specific Validators

  private static func validatePrimaryKeyUniqueness(_ context: ValidationContext)
    -> (
      failures: [ValidationResult.InvariantFailure],
      warnings: [ValidationResult.InvariantWarning])
  {
  ...
  private static func validateReferentialIntegrity(_ context: ValidationContext)
    -> (
      failures: [ValidationResult.InvariantFailure],
      warnings: [ValidationResult.InvariantWarning])
  {
  ...
  private static func validateDataTypeValidity(_ context: ValidationContext)
    -> (
      failures: [ValidationResult.InvariantFailure],
      warnings: [ValidationResult.InvariantWarning])
  {
  ...
  private static func validateEnumValueValidity(_ context: ValidationContext)
    -> (
      failures: [ValidationResult.InvariantFailure],
      warnings: [ValidationResult.InvariantWarning])
  {
  ...
  private static func validateDateBoundsValidity(_ context: ValidationContext)
    -> (
      failures: [ValidationResult.InvariantFailure],
      warnings: [ValidationResult.InvariantWarning])
  {
  ...
  private static func validateCounterMonotonicity(_ context: ValidationContext)
    -> (
      failures: [ValidationResult.InvariantFailure],
      warnings: [ValidationResult.InvariantWarning])
  {
  ...
  private static func validateStringLengthBounds(_ context: ValidationContext)
    -> (
      failures: [ValidationResult.InvariantFailure],
      warnings: [ValidationResult.InvariantWarning])
  {
  ...
  private static func validateRequiredFieldPresence(_ context: ValidationContext)
    -> (
      failures: [ValidationResult.InvariantFailure],
      warnings: [ValidationResult.InvariantWarning])
  {
  ...
  private static func validateRelationshipConsistency(_ context: ValidationContext)
    -> (
      failures: [ValidationResult.InvariantFailure],
      warnings: [ValidationResult.InvariantWarning])
  {
  ...
  private static func validateBusinessRuleCompliance(_ context: ValidationContext)
    -> (
      failures: [ValidationResult.InvariantFailure],
      warnings: [ValidationResult.InvariantWarning])
  {
    ...
    for habit in context.habits {
      ...
      let daysSinceStart = Calendar.current
        .dateComponents([.day], from: habit.startDate, to: Date()).day ?? 0
  ...
  private static func createValidationSummary(
    ...
    failures: [ValidationResult.InvariantFailure],
    warnings: [ValidationResult.InvariantWarning],
    duration: TimeInterval) -> ValidationResult.ValidationSummary
  {
...
struct MigrationResumeToken: Codable {
  ...
  static func fromData(_ data: Data) -> MigrationResumeToken? {
    try? JSONDecoder().decode(MigrationResumeToken.self, from: data)
  }

  func isStepCompleted(_ stepName: String) -> Bool {
    completedSteps.contains(stepName)
  }
