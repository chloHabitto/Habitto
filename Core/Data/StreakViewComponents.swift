...
struct HeatmapCellView: View {
  ...
  private func heatmapColor(for completionPercentage: Double) -> Color {
    ...
    print(
      "🔍 HEATMAP COLOR DEBUG - Completion: \(completionPercentage)% | Clamped: \(clampedPercentage)% | Selected Color: \(selectedColor)")

    return selectedColor
  }
}

// MARK: - SummaryStatisticsView
