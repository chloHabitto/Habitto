...
enum AtomicFileWriterError: LocalizedError {
  ...
  var errorDescription: String? {
    ...
    case .writeFailed(let error):
      "Failed to write file atomically: \(error.localizedDescription)"
  ...
  var recoverySuggestion: String? {
    ...
    case .encodingFailed:
      "Check that the data can be encoded properly"
    case .decodingFailed:
