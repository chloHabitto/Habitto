                            ...
                            HStack(spacing: 0) {
                                ...
                                ForEach(0..<7, id: \.self) { dayIndex in
                                    ...
                                    HeatmapCellView(
                                        ...
                                        isVacationDay: VacationManager.shared.isActive && VacationManager.shared.isVacationDay(Calendar.current.date(byAdding: .day, value: dayIndex, to: selectedWeekStartDate) ?? selectedWeekStartDate)
                                    )
