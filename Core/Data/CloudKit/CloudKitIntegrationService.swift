...
// Note: Using the actual CloudKitConflictResolver from
...
// MARK: - CloudKitIntegrationService
...
class CloudKitIntegrationService: ObservableObject {
  ...
  func startSync() async {
    ...
    // TODO: Implement proper FeatureFlagManager
  ...
  func resolveConflicts() async {
    ...
    print(
      "✅ CloudKitIntegrationService: Resolved \(successCount) conflicts, \(conflictCount) remaining")
  }
...
struct CloudKitUsageStatistics {
  ...
  var formattedQuotaUsed: String {
    ByteCountFormatter.string(fromByteCount: Int64(quotaUsed), countStyle: .file)
  }

  var formattedQuotaLimit: String {
    ByteCountFormatter.string(fromByteCount: quotaLimit, countStyle: .file)
  }
}
