...
struct I18nPreferences: Codable, Equatable {
    ...
    var calendar: Calendar {
        ...
        switch calendarID {
        case "gregorian": calendarIdentifier = .gregorian
        case "islamic": calendarIdentifier = .islamic
        case "buddhist": calendarIdentifier = .buddhist
        case "chinese": calendarIdentifier = .chinese
        case "hebrew": calendarIdentifier = .hebrew
        case "indian": calendarIdentifier = .indian
        case "persian": calendarIdentifier = .persian
        default: calendarIdentifier = .gregorian
        }
    ...
    var isRTL: Bool {
        return locale.language.languageCode?.identifier == "ar" || 
...
class I18nPreferencesManager: ObservableObject {
    ...
    private static func createSystemPreferences() -> I18nPreferences {
        ...
        switch currentCalendar.identifier {
...
extension I18nPreferencesManager {
    ...
    var isNonGregorianCalendar: Bool {
        return preferences.isNonGregorianCalendar
    }
