...
class XPManager {
  ...
  /// 
  /// ⚠️ WARNING: This method calculates XP from completed days, but the source of truth
  /// is DailyAwardService. This should only be used for immediate UI feedback.
