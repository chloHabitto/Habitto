...
class AchievementManager: ObservableObject {
    ...
    func updateAchievementProgress(_ achievementId: UUID, progress: Int) {
        ...
        let _ = achievements[index].progress
    ...
    func updateAchievementProgress(by requirement: Achievement.AchievementRequirement, amount: Int = 1) {
...
extension Achievement.AchievementRequirement {
    func matches(_ other: Achievement.AchievementRequirement) -> Bool {
        switch (self, other) {
        case (.completeHabits, .completeHabits),
             (.maintainStreak, .maintainStreak),
             (.earnXP, .earnXP),
             (.completeDailyHabits, .completeDailyHabits),
