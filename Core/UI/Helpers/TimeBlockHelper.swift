...
enum TimeBlockHelper {
  ...
  static func analyzeTimePatterns(
    for _: Habit,
    completionRecords: [CompletionRecordEntity]) -> [TimeBlockAnalysis]
  {
  ...
  static func getOptimalTimeBlock(
    for habit: Habit,
    completionRecords: [CompletionRecordEntity]) -> TimeBlock?
  {
  ...
  static func getTimeBlockInsight(
    for habit: Habit,
    completionRecords: [CompletionRecordEntity]) -> String?
  {
    let analysis = analyzeTimePatterns(for: habit, completionRecords: completionRecords)
