...
class HabitPatternAnalyzer {
  ...
  static func analyzeSuccessCorrelations(
    for habit: Habit,
    completionRecords: [CompletionRecordEntity],
    difficultyLogs: [DifficultyLogEntity]) -> SuccessCorrelationInsight?
  {
    ...
    if let difficultyCorrelation = analyzeDifficultyCorrelation(
  ...
  static func analyzePerformanceTrends(
    for habit: Habit,
    completionRecords: [CompletionRecordEntity]) -> PerformanceTrendInsight?
  {
  ...
  static func analyzeComparativePerformance(
    habits: [Habit],
    completionRecords: [CompletionRecordEntity]) -> ComparativePerformanceInsight?
  {
    guard habits.count >= 2 else { return nil }

    // 1. Performance Ranking
    let performanceRanking = calculatePerformanceRanking(
      habits: habits,
      completionRecords: completionRecords)

    // 2. Category Performance
    let categoryPerformance = analyzeCategoryPerformance(
      habits: habits,
      completionRecords: completionRecords)

    // 3. Difficulty vs Performance
    let difficultyPerformance = analyzeDifficultyPerformanceCorrelation(
      habits: habits,
      completionRecords: completionRecords)

    // 4. Goal Achievement Rates
    let goalAchievementRates = calculateGoalAchievementRates(
      habits: habits,
      completionRecords: completionRecords)
  ...
  static func identifyRiskFactors(
    for habit: Habit,
    completionRecords: [CompletionRecordEntity],
    difficultyLogs: [DifficultyLogEntity]) -> RiskFactorInsight?
  {
    ...
    // 3. Difficulty Spikes
    if let difficultyRisk = identifyDifficultyBasedRisk(
      completionRecords: completionRecords,
      difficultyLogs: difficultyLogs)
    {
  ...
  private static func analyzeDayOfWeekCorrelation(completionRecords: [CompletionRecordEntity])
    -> SuccessCorrelation?
  {
  ...
  private static func analyzeTimeOfDayCorrelation(completionRecords: [CompletionRecordEntity])
    -> SuccessCorrelation?
  {
  ...
  private static func analyzeDifficultyCorrelation(
    completionRecords: [CompletionRecordEntity],
    difficultyLogs: [DifficultyLogEntity]) -> SuccessCorrelation?
  {
  ...
  private static func analyzeStreakCorrelation(completionRecords: [CompletionRecordEntity])
    -> SuccessCorrelation?
  {
  ...
  private static func analyzeSeasonalCorrelation(completionRecords: [CompletionRecordEntity])
    -> SuccessCorrelation?
  {
  ...
  private static func analyzeWeeklyTrends(completionRecords: [CompletionRecordEntity])
    -> [WeeklyTrend]
  {
  ...
  private static func analyzeMonthlyTrends(completionRecords: [CompletionRecordEntity])
    -> [MonthlyTrend]
  {
  ...
  private static func analyzeSeasonalTrends(completionRecords: [CompletionRecordEntity])
    -> [SeasonalTrend]
  {
  ...
  private static func calculateOverallTrend(
    weeklyTrends: [WeeklyTrend],
    monthlyTrends _: [MonthlyTrend]) -> TrendDirection
  {
  ...
  private static func calculateTrendStrength(overallTrend _: TrendDirection) -> TrendStrength {
  ...
  private static func calculatePerformanceRanking(
    habits: [Habit],
    completionRecords: [CompletionRecordEntity]) -> [HabitPerformance]
  {
    var habitPerformances: [HabitPerformance] = []

    for habit in habits {
      let habitRecords = completionRecords.filter { _ in
  ...
  private static func analyzeCategoryPerformance(
    habits: [Habit],
    completionRecords: [CompletionRecordEntity]) -> [CategoryPerformance]
  {
  ...
  private static func analyzeDifficultyPerformanceCorrelation(
    habits _: [Habit],
    completionRecords _: [CompletionRecordEntity]) -> DifficultyPerformanceCorrelation?
  {
  ...
  private static func calculateGoalAchievementRates(
    habits: [Habit],
    completionRecords: [CompletionRecordEntity]) -> [GoalAchievementRate]
  {
  ...
  private static func identifyTimeBasedRisk(completionRecords: [CompletionRecordEntity])
    -> RiskFactor?
  {
  ...
  private static func identifyDayBasedRisk(completionRecords: [CompletionRecordEntity])
    -> RiskFactor?
  {
  ...
  private static func identifyDifficultyBasedRisk(
    completionRecords _: [CompletionRecordEntity],
    difficultyLogs _: [DifficultyLogEntity]) -> RiskFactor?
  {
  ...
  private static func identifyStreakBasedRisk(completionRecords: [CompletionRecordEntity])
    -> RiskFactor?
  {
  ...
  private static func identifyEnvironmentalRisk(completionRecords _: [CompletionRecordEntity])
    -> RiskFactor?
  {
...
// MARK: - SuccessCorrelationInsight
...
// MARK: - ComparativePerformanceInsight
...
// MARK: - DifficultyPerformanceCorrelation
