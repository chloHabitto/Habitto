...
struct ReminderBottomSheet: View {
  ...
  init(
    ...
    onReminderSelected: @escaping (String) -> Void,
    initialReminders: [ReminderItem] = [],
    onRemindersUpdated: @escaping ([ReminderItem]) -> Void)
  {
  ...
  var body: some View {
    ...
    .sheet(isPresented: $showingAddReminderSheet) {
      AddReminderSheet(
        ...
        isEditing: editingReminderIndex != nil)
      { newTime in
  ...
  @State private var selectedReminderType = "Notification"
