...
struct ScheduleBottomSheet: View {
  ...
  @State private var selectedDays = "Everyday"
  @State private var selectedWeekDays: Set<String> = []

  // Frequency tab state
  @State private var selectedFrequency = "Weekly"
  @State private var selectedFrequencyDays = "Every week"
  @State private var selectedFrequencyWeekDays: Set<String> = []
  @State private var weeklyValue = 1
  @State private var monthlyValue = 1
