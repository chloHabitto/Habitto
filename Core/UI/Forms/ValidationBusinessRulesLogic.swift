...
class ValidationBusinessRulesLogic {
    ...
    static func sortScheduleChronologically(_ schedule: String) -> String {
        return sortFrequencyChronologically(schedule)
    }
    ...
    static func validateHabitBreaking(baselineNumber: String, targetNumber: String, targetUnit: String, targetFrequency: String) -> (isValid: Bool, errorMessage: String?) {
        // Baseline validation
    ...
    static func validateHabitDates(startDate: Date, endDate: Date?) -> (isValid: Bool, errorMessage: String?) {
        let today = Date()
    ...
    static func validateReminders(_ reminders: [ReminderItem]) -> (isValid: Bool, errorMessage: String?) {
