...
// MARK: - Habit Instance Logic Helper
class HabitInstanceLogic {
    ...
    static func calculateHabitInstances(habit: Habit, daysPerWeek: Int, targetDate: Date) -> [HabitInstance] {
        let calendar = Calendar.current
