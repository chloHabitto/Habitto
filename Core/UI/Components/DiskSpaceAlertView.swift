...
// MARK: - Disk Space Alert Manager
@MainActor
class DiskSpaceAlertManager: ObservableObject {
    static let shared = DiskSpaceAlertManager()
    
    @Published var isShowing = false
    @Published var requiredSpace: Int = 0
    @Published var availableSpace: Int = 0
...
// MARK: - Disk Space Alert Modifier
