...
// MARK: - ProgressCalendarHeaderRow
...
// MARK: - ProgressCalendarTodayButton
...
// MARK: - ProgressCalendarDaysHeader
...
// MARK: - ProgressCalendarEmptyCells
...
struct ProgressCalendarDayCell: View {
  ...
  var body: some View {
    Button(action: {
      ...
      if let dateForDay = calendar.date(
        byAdding: .day,
        value: day - 1,
