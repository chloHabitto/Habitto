...
// MARK: - StreakTypography

enum StreakTypography {
  // Display Text
...
// MARK: - StreakAnimations

enum StreakAnimations {
  // Timing curves
...
// MARK: - StreakGlassmorphism

enum StreakGlassmorphism {
...
// MARK: - StreakCardStyles

enum StreakCardStyles {
  /// Primary card style
